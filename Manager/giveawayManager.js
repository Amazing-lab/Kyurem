const { parseDuration } = require('/home/container/Manager/parseDuration.js');
const { addGiveaway, addUserToGiveawayDB, fetchParticipantsFromDB, deleteGiveaway, getGiveawayDetails, removeWinnersFromDB, getAllGiveawaysInfo, fetchParticipantsAll, getActiveGiveaways, getEndedGiveaways, deletePermanentDB } = require('/home/container/Manager/giveawayDB.js');
...
async function startGiveaway(prize, duration, message, winnersCount, host) {
  const em = new EmbedBuilder()
        .setTitle('Giveaway!')
        .setDescription(`> <a:giveaway_box:1172714418107318333> **Giveaway Prize:** ${prize}\n> <a:win_giveaway:1172714906764709939> **Winner(s):** ${winnersCount}\n> <a:bluecrown:1172711288925847612> **Host:** <@${host}>\n> <a:SandClock:1172712022576734271> **Ends on:** <t:${Math.floor((Date.now() + parseDuration(duration))/1000)}:f> (<t:${Math.floor((Date.now() + parseDuration(duration))/1000)}:R>)\n\nReact <a:vip_giveaway:1172634054286393356> to join!`)
        .setColor(0xFFA500)
  const giveawayMessage = await message.channel.send({ embeds: [em] });
  giveawayMessage.react('<a:vip_giveaway:1172634054286393356>');
  ...
  const filter = (reaction, user) => reaction.emoji.id === '1172634054286393356' && !user.bot;
  ...
  collector.on('end', async (collected, reason) => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(`> <a:giveaway_box:1172714418107318333> **Giveaway Prize:** ${prize}\n> <a:win_giveaway:1172714906764709939> **Winner(s):** No eligible participants.`)
      .setColor(0xFFA500);
    ...
    const e = new EmbedBuilder()
      ...
      .setDescription(`<a:vip_giveaway:1172634054286393356> You have won the giveaway for **${details.prize}!** <a:happy:1172707328533987349>\n> <:important:1172708120305348681> This needs your immediate attention as **a rerolled prize will never come back!** | [Giveaway Link](https://discord.com/channels/${details.guildId}/${details.channelId}/${giveawayMessage.id})`)
      .setColor(0xFFC0CB)
    ...
    const embedWin = new EmbedBuilder()
      .setTitle('Giveaway Ended!')
      .setDescription(`> <a:giveaway_box:1172714418107318333>**Giveaway Prize:** ${prize}\n> <a:win_giveaway:1172714906764709939>**Winner(s):** ${winners.join(', ')}`)
      .setColor(0xFFA500);

    if (winners.length > 0) {
      await removeWinnersFromDB(giveawayMessage.id, win);
      await giveawayMessage.edit({ embeds: [embedWin] });
      await giveawayMessage.reply(`<a:vip_giveaway:1172634054286393356> **Congratulations to ${winners.join(', ')} for winning the giveaway!**`);
      win.forEach((u) => {
...
async function stopGiveaway(giveawayId, message) {
  try {
    ...
    const embed = new EmbedBuilder()
      .setTitle('Giveaway Ended!')
      .setDescription(`> <a:giveaway_box:1172714418107318333>**Giveaway Prize:** ${details.prize}\n> <a:win_giveaway:1172714906764709939>**Winner(s):** No eligible participants.`)
      .setColor(0xFFA500);
    ...
    const e = new EmbedBuilder()
      .setTitle('Congratulations!')
      .setDescription(`<a:vip_giveaway:1172634054286393356> You have won the giveaway for **${details.prize}!** <a:happy:1172707328533987349>\n> <:important:1172708120305348681> This needs your immediate attention as **a rerolled prize will never come back!** | [Giveaway Link](https://discord.com/channels/${details.guildId}/${details.channelId}/${giveawayId})`)
      .setColor(0xFFC0CB)
